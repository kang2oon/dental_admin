			...
			<div class="table-responsive mgtop_vlow">
				<table class="table table-bordered table-reg">
					...
					<tr>
						...
						<th>진료구분</th>
						<td><select><option>임플란트</option><option>발치</option></select></td>
					</tr>
					<tr>
						<th>진료일</th>
...
<!-- 에디터 끝 -->
			...
			<div class="row">
				<div class="col-xs-12 text-center">
					<button class="btn btn-success btn-sm"><i class="ion-plus"></i> 진료등록</button> <button class="btn btn-danger btn-sm" onclick="javascript:history.back();"><i class="ion-close"></i> 취소</button>
				</div>
			</div>
		</div>
	</div>
