			...
			<div class="table-responsive mgtop_vlow">
				<table class="table table-bordered table-reg">
					...
					<tr>
						...
						<th class="required">차트번호</th>
						<td><input type="text" /> <button class="btn btn-warning btn-xs">중복검사</button></td>
					</tr>
					<tr>
						<th class="required">휴대폰</th>
						<td><select><option>010</option></select> - <input type="text" style="width:50px;"/> - <input type="text"  style="width:50px;"/></td>
						<th>일반전화</th>
						<td><select><option>02</option></select> - <input type="text" style="width:50px;"/> - <input type="text"  style="width:50px;"/></td>
					</tr>
					<tr>
						<th>이메일</th>
						<td colspan="3"><input type="text" style="width:350px;"/></td>
					</tr>
					<tr>
						<th>주소</th>
						<td colspan="3">
							<input type="text" id="post1" style="width:50px;"> - <input type="text" id="post2" style="width:50px;">
							<input type="button" onclick="openDaumPostcode()" value="우편번호 찾기" class="btn btn-warning btn-xs"><br/>
							<input type="text" id="addr" style="width:350px;" class="mgtop_vlow"> <input type="text" id="addr2" style="width:350px;" class="mgtop_vlow">
						</td>
					</tr>
					<tr>
						<th>회원 메모</th>
...
<!-- 에디터 끝 -->
			...
			<div class="row">
				<div class="col-xs-12 text-center">
					<button class="btn btn-primary btn-sm"><i class="ion-plus"></i> 회원등록</button> <button class="btn btn-danger btn-sm"><i class="ion-close"></i> 취소</button>
				</div>
			</div>
		</div>
	</div>
